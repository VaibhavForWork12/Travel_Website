  ...
  return (
    ...
    py-10 lg:mb-10 lg:py-20 xl:mb-20">
       ...
       overflow-x-auto lg:h-[400px] xl:h-[640px]">
         ...
         title="Putuk Camp"
         subtitle="Prigen,Oregon"
         peopleJoined="45+ Joined"/>

         <CampSite
          backgroundImage="bg-bg-img-2"
          title="Tutuk Camp"
          subtitle="Somewhere in world"
       ...
       <div className=" flexEnd mt-10 px-6 lg:mt-60 lg:mr-6">
        ...
        xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-3xl">
          ...
          <strong> Feeling lost </strong> and seeking direction?
          </h2>
          <p className="regular-14 xl:regular-16 mt-5 text-white">
          Let us be your compass. With our expert guidance and personalized recommendations, 
           we'll navigate you to the perfect destination tailored to your wanderlust desires.
           Embark on a journey of discovery with confidence and ease."
          </p>
          <Image
          src="/quote.svg"
          alt="camp-2"
